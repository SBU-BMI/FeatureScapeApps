console.log('multimodal.js loaded');
...
window.onload = function () {
    ...
    $.getJSON('../data/patients_multimodal.json').then(function (x) {
        $.getJSON('../data/patients_fig4.json').then(function (f4) {
            // create dictionary to borrow months_followup from fig4
            //var dic ={}
            ...
            if (searchParms.morph1) {
                ...
                morphParm1.value = "Roundness_50"
            }

            if (searchParms.morph2) {
                morphParm2.value = searchParms.morph2
            } else {
                morphParm2.value = "compactness"
            }

            if (searchParms.morph3) {
                morphParm3.value = searchParms.morph3
            } else {
                morphParm3.value = "age_at_initial_pathologic_diagnosis"
            }
